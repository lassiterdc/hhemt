...
def test_job_index_recovers_ids_the_sidecar_lost():
    ...
    payloads = [
        {
            "slurm_job_id": "111",
            "rule_name": "simulation_sa_gpu_0_r1_evt_0",
            "sa_id": "gpu_0_r1",
            "event_id": "0",
    ...
    job_index = {"222": "simulation_sa_gpu_1_r1_evt_3"}
    ...
    assert out["222"]["sa_id"] == "gpu_1_r1", "sa_id must survive an underscore-bearing id"
...
def test_tier1_wins_where_both_sources_carry_the_same_job():
    ...
    job_index = {"111": "process_sa_gpu_0_r1_evt_0"}

    out = _job_purpose_map(payloads, job_index)

    assert out["111"]["rule_name"] == "simulation_sa_gpu_0_r1_evt_0"
...
def test_absent_index_is_identical_to_tier1_alone():
    ...
    payloads = [
        {
            "slurm_job_id": "111",
            "rule_name": "consolidate_sa_gpu_0_r1",
            "sa_id": "gpu_0_r1",
            "event_id": "",
            "model_type": "tritonswmm",
        }
...
def test_evtless_rule_name_yields_sa_id_and_empty_event():
    """`consolidate_sa_{id}` has no `_evt_` segment; the sa_id capture must still close."""
    out = _job_purpose_map([], {"333": "consolidate_sa_gpu_2_r1"})
...
def test_model_type_is_left_empty_rather_than_guessed():
    ...
    out = _job_purpose_map([], {"444": "simulation_sa_gpu_1_r1_evt_0"})
