...
@pytest.fixture(scope="session")
def rendered_synth_multi_sim(tritonswmm_cpu_compiled):
...
@pytest.fixture(scope="session")
def rendered_synth_sensitivity(tritonswmm_cpu_compiled):
    ...
    ``tritonswmm_cpu_compiled`` compile-tier gate). Uses
