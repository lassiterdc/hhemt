...
main_scratch: /home/***REMOVED***/dev/agentic-workspace/library/_scratch/workspaces/TRITON-SWMM_toolkit_05-14_1432_plotly-html-extension-pwi.md
last_sync_hashes:
...
worktree_path: /home/***REMOVED***/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-14_1432_plotly-html-extension-pwi
...
- Worktree: `/home/***REMOVED***/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-14_1432_plotly-html-extension-pwi`
...
1. Wrapup-handoff sidecar:
   `/home/***REMOVED***/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-14_1432_plotly-html-extension-pwi/sidecars/sidecar_wrapup_2026-05-14_2001.md`
...
- **Plan name**: `plotly figure file extension html`
- **Plan completion commit**: `39c0fa6d87550b376a54357a5ef84a43ea502240`
- **Worktree path**: `/home/***REMOVED***/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-14_1432_plotly-html-extension-pwi`
- **Worktree branch**: `worktree-toolkit_05-14_1432_plotly-html-extension-pwi`
...
--inject-into-scratch /home/***REMOVED***/dev/agentic-workspace/library/_scratch/workspaces/TRITON-SWMM_toolkit_05-14_1432_plotly-html-extension-pwi.md` to append the wrapup template
...
- **Worktree path**: `/home/***REMOVED***/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-14_1432_plotly-html-extension-pwi`
- **Worktree branch**: `worktree-toolkit_05-14_1432_plotly-html-extension-pwi`
- **Main scratch path**: `/home/***REMOVED***/dev/agentic-workspace/library/_scratch/workspaces/TRITON-SWMM_toolkit_05-14_1432_plotly-html-extension-pwi.md`
...
Do NOT read the main scratch doc. Do NOT compute hashes yourself. Invoke:
    ...
    scripts/generate/write_compaction_sidecar.py --mode verify \
      --main-scratch /home/***REMOVED***/dev/agentic-workspace/library/_scratch/workspaces/TRITON-SWMM_toolkit_05-14_1432_plotly-html-extension-pwi.md \
      --worktree /home/***REMOVED***/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-14_1432_plotly-html-extension-pwi
...
- **Halt-override 2026-05-14 21:30 (Part 3 hash mismatch)**: `--mode verify` exited 2 on a `# Follow-up Ideas` hash mismatch (NOT a dirty worktree this time). The mismatch is sidetrack-attributable: during this session, multiple legitimate appends to main scratch's `# Follow-up Ideas` landed via `append_scratch_section.py` — the AW specialist's F-FU items, the git specialist's findings, the smell-investigation outputs, and the plan-A-driven implementation notes. These appends post-date the sidecar's `last_sync_hashes` baseline (frozen at `--mode create-wrapup-handoff` time pre-compaction). The hash check is a stale-PRE-compaction-edit detector; edits made AFTER the wrapup sidecar was emitted are not what it's designed to flag. Furthermore, wrapup-session Step 7 (`/review-followup-ideas`) itself writes to `# Follow-up Ideas`, so the check is structurally incompatible with the workflow that follows. User explicitly authorized override 2026-05-14 21:30. Proceeding to `/wrapup-session` directly. Per the post-halt protocol I did NOT run `--mode sync-back` on this wrapup-handoff sidecar.
