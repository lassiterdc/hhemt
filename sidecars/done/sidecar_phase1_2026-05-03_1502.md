...
last_sync_hashes:
  ...
  '# Follow-up Ideas': a7d6c246b9d9b4375e5e47290ff4e25b38caae11627780d010a1d5b12d45a235
harness: claude-code
next_phase: '1'
next_phase_title: bundle spec discovery via curated example
next_phase_doc: /home/dcl3nd/dev/agentic-workspace/library/docs/planning/projects/TRITON-SWMM_toolkit/features/render_bundle/1 bundle spec discovery via curated example.md
...
- Next phase: Phase 1 — bundle spec discovery via curated example
- Next phase doc: `/home/dcl3nd/dev/agentic-workspace/library/docs/planning/projects/TRITON-SWMM_toolkit/features/render_bundle/1 bundle spec discovery via curated example.md`
...
1. Sidecar scratch doc:
   `/home/dcl3nd/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-03_1359_render-bundle-pwi/sidecars/sidecar_phase1_2026-05-03_1502.md`

2. Next phase doc:
   `/home/dcl3nd/dev/agentic-workspace/library/docs/planning/projects/TRITON-SWMM_toolkit/features/render_bundle/1 bundle spec discovery via curated example.md`
...
- **Phase**: 1 — bundle spec discovery via curated example
- **Heaviness**: medium
...
`Checkpoint-match assertion: Sidecar: sidecar_phase1_2026-05-03_1502.md. Leave-off step (from
checkpoint): preflight complete, entering Phase 1. Next phase: Phase 1 — bundle spec discovery via curated example.
