...
last_sync_hashes:
  ...
  '# Follow-up Ideas': 4ff1282510f65938091d83c42139bfc136117d69015627c4f6af469aff809a44
harness: claude-code
next_phase: '1'
next_phase_title: 'renderer refactor: eliminate per-sim file dependencies'
next_phase_doc: /home/dcl3nd/dev/agentic-workspace/library/docs/planning/projects/TRITON-SWMM_toolkit/features/render_bundle/1 renderer refactor consolidate per sim reads.md
...
- Next phase: Phase 1 — renderer refactor: eliminate per-sim file dependencies
- Next phase doc: `/home/dcl3nd/dev/agentic-workspace/library/docs/planning/projects/TRITON-SWMM_toolkit/features/render_bundle/1 renderer refactor consolidate per sim reads.md`
...
1. Sidecar scratch doc:
   `/home/dcl3nd/dev/TRITON-SWMM_toolkit/.claude/worktrees/toolkit_05-03_1359_render-bundle-pwi/sidecars/sidecar_phase1_2026-05-03_1946.md`

2. Next phase doc:
   `/home/dcl3nd/dev/agentic-workspace/library/docs/planning/projects/TRITON-SWMM_toolkit/features/render_bundle/1 renderer refactor consolidate per sim reads.md`
...
- **Phase**: 1 — renderer refactor: eliminate per-sim file dependencies
- **Heaviness**: medium
...
`Checkpoint-match assertion: Sidecar: sidecar_phase1_2026-05-03_1946.md. Leave-off step (from
checkpoint): preflight complete, entering Phase 1. Next phase: Phase 1 — renderer refactor: eliminate per-sim file dependencies.
