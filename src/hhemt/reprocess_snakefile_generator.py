...
:class:`hhemt.workflow.SnakemakeWorkflowBuilder`.
...
Distinct from :mod:`hhemt.bundle.snakefile_generator`
...
onerror:
    ...
    shell("""
        {builder.python_executable} -m hhemt.export_scenario_status \\
            {config_args} \\
...
{render_resources}
    shell:
        """
        {builder.python_executable} -m hhemt.render_report_runner \\
            {config_args} \\
