...
**Max / full flow**: ratio of maximum flow to full-pipe flow capacity per conduit. **Peak flow**: peak flow magnitude per conduit. Colormaps and bounds are configured in ``cfg_analysis.yaml`` under ``report.per_sim.conduit_flow``.
