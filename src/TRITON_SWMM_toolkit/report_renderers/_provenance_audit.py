    ...
    if leaked:
        raise ProcessingError(
            ...
            reason=(
                ...
                "incidental infrastructure. Set TRITON_SWMM_DISABLE_PROVENANCE_AUDIT=1 "
...
def audit_renderer_io(output_path, analysis_dir, *, renderer_name: str):
    ...
    Fail-open kill-switch: when TRITON_SWMM_DISABLE_PROVENANCE_AUDIT=1 the CM
    ...
    """
    if os.environ.get("TRITON_SWMM_DISABLE_PROVENANCE_AUDIT") == "1":
        yield
        return
