...
class TRITONSWMM_analysis_plotting:
    ...
    @property
    def triton_ds(self):
        return self._analysis._tritonswmm_TRITON_summary

    @property
    def swmm_node_ds(self):
        return self._analysis._tritonswmm_SWMM_node_summary

    @property
    def swmm_link_ds(self):
        return self._analysis._tritonswmm_SWMM_link_summary
